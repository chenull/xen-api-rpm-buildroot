...
BuildRequires: elfutils-libelf-devel, zlib-devel, binutils-devel, newt-devel, python-devel, perl(ExtUtils::Embed), gtk2-devel, bison, module-init-tools, patch, bash, sh-utils, tar, bzip2, findutils, gzip, m4, perl, make, diffutils, gawk, redhat-rpm-config, net-tools, patchutils, rpm-build, xmlto, asciidoc, kernel, kernel-devel, fileutils, gawk
Requires: kernel, fileutils, findutils, gawk, bash

#Patches
Patch0:   centos-e1000e-Makefile.patch
...
%changelog
* Sun Jul 21 2013 Akemi Yagi <toracat@centos.org> - 2.4.14-3.4.53.1.el5.centos.alt
- Added Makefile patch to enable mock build.

* Thu Jul 18 2013 Johnny Hughes <johnny@centos.org> - 2.4.14-3.4.53.el6.centos.alt
- initial build for the Xen4CentOS project
- CentOS bug 6562
