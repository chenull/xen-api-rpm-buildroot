...
#added by CentOS
Patch200: 01-04172610c0630201626b837a05722d40bdae2aa6.patch
Patch201: 02-e0622ca28163f2b4a5fbf40266bbc30986acee14.patch
Patch202: 03-889ce7460c706a8528bce444827261b288280490.patch
Patch203: 04-ce33422d35e7b827be12f23ab3af8888f5d01641.patch
Patch204: 05-02ed255e2244df050317bd961b3e779ab1b5393c.patch
Patch205: 06-702911496fd7be9b90988828807e72573d0e9c22.patch
Patch206: libvirt-0.10.2.5-make-libxlDomainObjPrivate-libvirt-object.patch
Patch207: libvirt-40e904490f0697a4363f0f3c359231f255d559b9.patch

#added from libvirt-git
Patch400: virsh-edit-XML-string-leak.patch
Patch401: virCgroupGetValueStr-invalid-read.patch
Patch402: storage-nomount-fs-pool.patch
...
%changelog
* Fri Jul 19 2013 Johnny Hughes <johnny@centos.org> - 0.10.2.6-1.el6.centos.alt
- upgraded to upstream version 0.10.2.6
- removed patches 100, 101, 102, 103, 300, 301, 302, 303 as they are rolled in upstream now
- renumbered patches 304 and 305 to 206 and 207.  The 200 series of patches are added by CentOS.
- added new patches 400, 401, 402 from libvirt upstream (400 series are upstream imported patches)

* Thu Jun 13 2013 Johnny Hughes <johnny@centos.org> - 0.10.2.4-5.el6.centos.alt
- added patches 304 and 305 for libxl 

* Thu May 30 2013 Johnny Hughes <johnny@centos.org> - 0.10.2.4-4.el6.centos.alt
- roll in patches 300, 301, 302, 303 from the libvirt.org 0.10.2.maint channel

* Mon May 20 2013 Johnny Hughes <johnny@centos.org> - 0.10.2.4-3.el6.centos.alt
- added patches 102 and 103 from libvirt.org 0.10.2 maint branch
- patch 102 fixes security issue (CVE-2013-1962)
- added patches 200 through 205 for xen stabilization from Frediano Ziglio (frediano.ziglio@citrix.com)

* Wed May 01 2013 Johnny Hughes <johnny@centos.org> - 0.10.2.4-2.el6.centos.alt
- added patches 100 and 101 from libvirt.org 0.10.2 maint branch
